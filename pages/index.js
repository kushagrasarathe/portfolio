  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main} id="main">
        ...
        <h1 className={`${styles.name}  ${styles.gradient_text}`}>
      ...
      <div className={`${styles.about} ${styles.slider}`}>
        ...
        <p>
          ...
          Frontend Developer based in India. I had been doing bug-bounty hunting
          for past two years and had been reporting security flaws to different
          companies.
          <br />
          <br />
